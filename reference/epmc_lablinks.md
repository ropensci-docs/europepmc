...
advanced search, include Wikipedia, Dryad Digital Repository or other
open services. For more information, see
...
- lab_id:
  ...
  character vector, identifiers of the external link service. Use Europe
  PMC's advanced search form to find ids.

- limit:

  Number of records to be returned. By default, this function returns
  100 records.
